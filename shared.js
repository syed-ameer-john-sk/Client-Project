...
const translations = {
    en: {
        ...
        promise_text: "We safeguard your projects, your data, and your deadlines.",
        conviction_text: "Our approach is based on a simple belief: the quality of clinical execution depends above all on the human, scientific, and operational expertise of the resources we mobilize.",
        testimonials_label: "Testimonials",
        testimonials_title: "What Our Partners Say",
        testimonial_1: "Consultant sur Mesure supported us with an experienced Clinical Research professional who integrated seamlessly into our ongoing study. <strong>Their understanding of regulatory standards and commitment to quality delivery truly strengthened our project execution.</strong>",
        testimonial_1_role: "Clinical Operations Director",
        testimonial_1_company: "Pharmaceutical Sponsor",
        testimonial_2: "<strong>Their tailored consulting approach and deep knowledge of Life Sciences enabled us to accelerate a critical development phase.</strong> The expertise provided was precise, efficient, and aligned with our scientific and operational objectives.",
        testimonial_2_role: "R&D Manager",
        testimonial_2_company: "Biotech Company",
        testimonial_3: "Consultant sur Mesure acts as a strategic partner rather than a traditional recruitment provider. <strong>Their continuous support, industry insight, and flexible collaboration model make them a trusted extension of our team.</strong>",
        testimonial_3_role: "HR & Talent Director",
        testimonial_3_company: "Life Sciences Organization",
        cta_label: "Take the Next Step",
        cta_title: "Discover Our Commitments",
        cta_text: "Discover our commitments, the principles that guide our work, and what sets us apart in the life sciences consulting market.",
        ...
        comp_pillar1_list: "• Clinical Research Associate (CRA)\n• Project Manager\n• Qualified Audit Experts\n• Audit and Regulatory Affairs Support",
        ...
        comp_pillar2_list: "• Digital Audits and Strategies\n• Implementation of Digital Solutions\n• CTRF/CTMS\n• Paperless Transition\n• Digital Systems Training\n• IT Professionals and Profiles (Technical Support and Solution Development)\n• Digital Transformation Specialists (Consulting and Support for the Integration of Advanced Technologies, AI, and Automation)",
    ...
    fr: {
        ...
        promise_text: "Nous protégeons vos projets, vos données et vos délais.",
        conviction_text: "Notre approche repose sur une croyance simple : la qualité de l'exécution clinique dépend avant tout de l'expertise humaine, scientifique et opérationnelle des ressources que nous mobilisons.",
        testimonials_label: "Témoignages",
        testimonials_title: "Ce que disent nos partenaires",
        testimonial_1: "Consultant sur Mesure nous a accompagnés avec un professionnel expérimenté en Recherche Clinique qui s'est intégré de manière transparente dans notre étude en cours. <strong>Sa compréhension des normes réglementaires et son engagement envers la qualité ont véritablement renforcé l'exécution de notre projet.</strong>",
        testimonial_1_role: "Directeur des Opérations Cliniques",
        testimonial_1_company: "Sponsor Pharmaceutique",
        testimonial_2: "<strong>Leur approche de conseil sur mesure et leur connaissance approfondie des Sciences de la Vie nous ont permis d'accélérer une phase de développement critique.</strong> L'expertise fournie était précise, efficace et alignée sur nos objectifs scientifiques et opérationnels.",
        testimonial_2_role: "Responsable R&D",
        testimonial_2_company: "Entreprise Biotech",
        testimonial_3: "Consultant sur Mesure agit en tant que partenaire stratégique plutôt qu'un fournisseur de recrutement traditionnel. <strong>Leur soutien continu, leur connaissance du secteur et leur modèle de collaboration flexible en font une extension de confiance de notre équipe.</strong>",
        testimonial_3_role: "Directeur RH & Talents",
        testimonial_3_company: "Organisation Sciences de la Vie",
        cta_label: "Passez à l'étape suivante",
        cta_title: "Découvrez nos engagements",
        cta_text: "Découvrez nos engagements, les principes qui guident notre travail, et ce qui nous distingue sur le marché du conseil en sciences de la vie.",
        ...
        comp_pillar1_list: "• Attaché de Recherche Clinique (ARC)\n• Chef de Projet\n• Experts en Audit Qualifié\n• Support Audit et Affaires Réglementaires",
        ...
        comp_pillar2_list: "• Audits et Stratégies Digitales\n• Implémentation de Solutions Digitales\n• CTRF/CTMS\n• Transition Zéro-Papier\n• Formation aux Systèmes Digitaux\n• Professionnels et Profils IT (Support Technique et Développement de Solutions)\n• Spécialistes en Transformation Digitale (Conseil et Support pour l'Intégration des Technologies Avancées, IA et Automatisation)",
